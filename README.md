...
project build directory and the resources from our **dist/iaccounting** generated folder. 
...
directory. The **dist/iaccounting** folder is used to be placed inside the build output.
